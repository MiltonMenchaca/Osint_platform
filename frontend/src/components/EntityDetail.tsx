...
const EntityDetail: React.FC<EntityDetailProps> = ({
  ...
  const loadEntity = async () => {
    try {
      ...
      // Load relationships
      try {
        const relationshipsResponse = await apiService.getEntityRelationships(entityId);
        if (relationshipsResponse.success && relationshipsResponse.data) {
          setRelationships(relationshipsResponse.data);
        }
      } catch (err) {
        console.warn('Could not load relationships:', err);
      }
          ...
          {activeTab === 'relationships' && (
            <RelationshipManager
              ...
              onRelationshipChange={() => {
                ...
                apiService.getEntityRelationships(entity.id)
                  .then(response => {
